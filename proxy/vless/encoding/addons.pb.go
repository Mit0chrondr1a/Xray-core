...
type Addons struct {
	...
	BypassVisionPayload bool                   `protobuf:"varint,3,opt,name=BypassVisionPayload,proto3" json:"BypassVisionPayload,omitempty"`
...
func (x *Addons) GetBypassVisionPayload() bool {
	if x != nil {
		return x.BypassVisionPayload
	}
	return false
}
...
const file_proxy_vless_encoding_addons_proto_rawDesc = "" +
	"\n" +
	"!proxy/vless/encoding/addons.proto\x12\x19xray.proxy.vless.encoding\"b\n" +
	"\x06Addons\x12\x12\n" +
	"\x04Flow\x18\x01 \x01(\tR\x04Flow\x12\x12\n" +
	"\x04Seed\x18\x02 \x01(\fR\x04Seed\x120\n" +
	"\x13BypassVisionPayload\x18\x03 \x01(\bR\x13BypassVisionPayloadBm\n" +
